...
public class DummyDataInitializer implements CommandLineRunner {
        ...
        private List<Package> createPackages(List<Activity> activities) {
                ...
                if (flight2 != null) {
                        Plan plan4 = createPlanUnfinished(pkg2.getId(), "Flight", flight2.getStartDate(),
                                        flight2.getEndDate(), flight2.getStartLocation(), flight2.getEndLocation());
                        pkg2.getPlans().add(plan4);
                }

                if (hotel2 != null) {
                        Plan plan5 = createPlanUnfinished(pkg2.getId(), "Accommodation", hotel2.getStartDate(),
                                        hotel2.getEndDate(), hotel2.getStartLocation(), hotel2.getEndLocation());
